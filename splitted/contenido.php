...
<html>
	...
	<style>
			header nav ul li span.pagcontenido{background-color: #638dc4;}
	</style>
	...
	<body>
		<!-- Menu -->
			...
			<div id="empresa" class="secciones" >
					<div id="pagcontenido-contenido" class="contenido">
					<?php include('logo.php'); ?>
						<table>
								...
								<div class="info-liceos" onclick="showinfo('liceo-1',6,6,6)">
									<div class="perfil">
										<img src='images/pagcontenido/liceo-1.png' width='50px' height='50px'/>
										<p>Liceo 1 con un nombre bastante largo</p>
									</div>
								</div>
								<div class="info-liceos" onclick="showinfo('liceo-2',6,6,6)">
									<div class="perfil">
										<img src='images/pagcontenido/liceo-2.png' width='50px' height='50px'/>
										<p>Liceo 2</p>
									</div>
								</div>
								<div class="info-liceos" onclick="showinfo('liceo-3',6,6,6)">
									<div class="perfil">
										<img src='images/pagcontenido/liceo-3.png' width='50px' height='50px'/>
										<p>Liceo 3</p>
									</div>
								</div>
								<div class="info-liceos" onclick="showinfo('liceo-4',6,6,6)">
									<div class="perfil">
										<img src='images/pagcontenido/liceo-4.png' width='50px' height='50px'/>
										<p>Liceo 4</p>
									</div>
								</div>
								<div class="info-liceos" onclick="showinfo('liceo-5',6,6,6)">
									<div class="perfil">
										<img src='images/pagcontenido/liceo-5.png' width='50px' height='50px'/>
										<p>Liceo 5</p>
									</div>
								</div>
								<div class="info-liceos" onclick="showinfo('liceo-6',6,6,6)">
									<div class="perfil">
										<img src='images/pagcontenido/liceo-6.png' width='50px' height='50px'/>
										<p>Liceo 6</p>
									</div>	
								</div>
								</div>
								...
								<div class="info-profesores" onclick="showinfo('profesor-1',6,6,6)">
									<div class="perfil">
										<img src='images/pagcontenido/profesor-1.png' width='50px' height='50px'/>
										<p>Profesor 1 </p>
									</div>
								</div>
								<div class="info-profesores" onclick="showinfo('profesor-2',6,6,6)">
									<div class="perfil">
										<img src='images/pagcontenido/profesor-2.png' width='50px' height='50px'/>
										<p>Profesor 2 </p>
									</div>	
								</div>
								<div class="info-profesores" onclick="showinfo('profesor-3',6,6,6)">
									<div class="perfil">
										<img src='images/pagcontenido/profesor-3.png' width='50px' height='50px'/>
										<p>Profesor 3 </p>
									</div>	
								</div>
								<div class="info-profesores" onclick="showinfo('profesor-4',6,6,6)">
									<div class="perfil">
										<img src='images/pagcontenido/profesor-4.png' width='50px' height='50px'/>
										<p>Profesor 4 </p>
									</div>	
								</div>
								<div class="info-profesores" onclick="showinfo('profesor-5',6,6,6)">
									<div class="perfil">
										<img src='images/pagcontenido/profesor-5.png' width='50px' height='50px'/>
										<p>Profesor 5 </p>
									</div>	
								</div>
								<div class="info-profesores" onclick="showinfo('profesor-6',6,6,6)">
									<div class="perfil">
										<img src='images/pagcontenido/profesor-6.png' width='50px' height='50px'/>
										<p>Profesor 6 </p>
									</div>	
								</div>
								</div>
								...
								<div class="info-alumnos" onclick="showinfo('alumno-1',6,6,6)">
									<div class="perfil">
										<img src='images/pagcontenido/alumno-1.png' width='50px' height='50px'/>
										<p>Alumno 1 </p>
									</div>	
								</div>
								<div class="info-alumnos" onclick="showinfo('alumno-2',6,6,6)">
									<div class="perfil">
										<img src='images/pagcontenido/alumno-2.png' width='50px' height='50px'/>
										<p>Alumno 2 </p>
									</div>	
								</div>
								<div class="info-alumnos" onclick="showinfo('alumno-3',6,6,6)">
									<div class="perfil">
										<img src='images/pagcontenido/alumno-3.png' width='50px' height='50px'/>
										<p>Alumno 3 </p>
									</div>		
								</div>
								<div class="info-alumnos" onclick="showinfo('alumno-4',6,6,6)">
									<div class="perfil">
										<img src='images/pagcontenido/alumno-4.png' width='50px' height='50px'/>
										<p>Alumno 4 </p>
									</div>		
								</div>
								<div class="info-alumnos" onclick="showinfo('alumno-5',6,6,6)">
									<div class="perfil">
										<img src='images/pagcontenido/alumno-5.png' width='50px' height='50px'/>
										<p>Alumno 5 </p>
									</div>	
								</div>
								<div class="info-alumnos" onclick="showinfo('alumno-6',6,6,6)">
									<div class="perfil">
										<img src='images/pagcontenido/alumno-6.png' width='50px' height='50px'/>
										<p>Alumno 6 </p>
									</div>	
								</div>
								</div>
								...
								<td class="perfiles-3">
										...
										<?php include('info_pagcontenido.php') ?>
								</td>	
						</table>
					</div>
				</div>
