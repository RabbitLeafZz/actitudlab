...
<html>
	...
	<style>
			header nav ul li span.experiencia{background-color: #2ac2d0;}
	</style>
	...
	<body>
		<!-- Menu -->
			...
			<div id="empresa" class="secciones" >
					<div id="experiencia-contenido" class="contenido">
					<?php include('logo.php'); ?>
						<table>
								...
								<div class="info-liceos" onclick="showinfo('liceo-1',6,6,6)">
									<div class="perfil">
										<img src='images/experiencia/liceo-1.png' width='50px' height='50px'/>
										<p>Liceo 1 con un nombre bastante largo</p>
									</div>
								</div>
								<div class="info-liceos" onclick="showinfo('liceo-2',6,6,6)">
									<div class="perfil">
										<img src='images/experiencia/liceo-2.png' width='50px' height='50px'/>
										<p>Liceo 2</p>
									</div>
								</div>
								<div class="info-liceos" onclick="showinfo('liceo-3',6,6,6)">
									<div class="perfil">
										<img src='images/experiencia/liceo-3.png' width='50px' height='50px'/>
										<p>Liceo 3</p>
									</div>
								</div>
								<div class="info-liceos" onclick="showinfo('liceo-4',6,6,6)">
									<div class="perfil">
										<img src='images/experiencia/liceo-4.png' width='50px' height='50px'/>
										<p>Liceo 4</p>
									</div>
								</div>
								<div class="info-liceos" onclick="showinfo('liceo-5',6,6,6)">
									<div class="perfil">
										<img src='images/experiencia/liceo-5.png' width='50px' height='50px'/>
										<p>Liceo 5</p>
									</div>
								</div>
								<div class="info-liceos" onclick="showinfo('liceo-6',6,6,6)">
									<div class="perfil">
										<img src='images/experiencia/liceo-6.png' width='50px' height='50px'/>
										<p>Liceo 6</p>
									</div>	
								</div>
								</div>
								...
								<div class="info-profesores" onclick="showinfo('profesor-1',6,6,6)">
									<div class="perfil">
										<img src='images/experiencia/profesor-1.png' width='50px' height='50px'/>
										<p>Profesor 1 </p>
									</div>
								</div>
								<div class="info-profesores" onclick="showinfo('profesor-2',6,6,6)">
									<div class="perfil">
										<img src='images/experiencia/profesor-2.png' width='50px' height='50px'/>
										<p>Profesor 2 </p>
									</div>	
								</div>
								<div class="info-profesores" onclick="showinfo('profesor-3',6,6,6)">
									<div class="perfil">
										<img src='images/experiencia/profesor-3.png' width='50px' height='50px'/>
										<p>Profesor 3 </p>
									</div>	
								</div>
								<div class="info-profesores" onclick="showinfo('profesor-4',6,6,6)">
									<div class="perfil">
										<img src='images/experiencia/profesor-4.png' width='50px' height='50px'/>
										<p>Profesor 4 </p>
									</div>	
								</div>
								<div class="info-profesores" onclick="showinfo('profesor-5',6,6,6)">
									<div class="perfil">
										<img src='images/experiencia/profesor-5.png' width='50px' height='50px'/>
										<p>Profesor 5 </p>
									</div>	
								</div>
								<div class="info-profesores" onclick="showinfo('profesor-6',6,6,6)">
									<div class="perfil">
										<img src='images/experiencia/profesor-6.png' width='50px' height='50px'/>
										<p>Profesor 6 </p>
									</div>	
								</div>
								</div>
								...
								<div class="info-alumnos" onclick="showinfo('alumno-1',6,6,6)">
									<div class="perfil">
										<img src='images/experiencia/alumno-1.png' width='50px' height='50px'/>
										<p>Alumno 1 </p>
									</div>	
								</div>
								<div class="info-alumnos" onclick="showinfo('alumno-2',6,6,6)">
									<div class="perfil">
										<img src='images/experiencia/alumno-2.png' width='50px' height='50px'/>
										<p>Alumno 2 </p>
									</div>	
								</div>
								<div class="info-alumnos" onclick="showinfo('alumno-3',6,6,6)">
									<div class="perfil">
										<img src='images/experiencia/alumno-3.png' width='50px' height='50px'/>
										<p>Alumno 3 </p>
									</div>		
								</div>
								<div class="info-alumnos" onclick="showinfo('alumno-4',6,6,6)">
									<div class="perfil">
										<img src='images/experiencia/alumno-4.png' width='50px' height='50px'/>
										<p>Alumno 4 </p>
									</div>		
								</div>
								<div class="info-alumnos" onclick="showinfo('alumno-5',6,6,6)">
									<div class="perfil">
										<img src='images/experiencia/alumno-5.png' width='50px' height='50px'/>
										<p>Alumno 5 </p>
									</div>	
								</div>
								<div class="info-alumnos" onclick="showinfo('alumno-6',6,6,6)">
									<div class="perfil">
										<img src='images/experiencia/alumno-6.png' width='50px' height='50px'/>
										<p>Alumno 6 </p>
									</div>	
								</div>
								</div>
								...
								<td class="perfiles-3">
										...
										<?php include('info_experiencia.php') ?>
								</td>	
						</table>
					</div>
				</div>
